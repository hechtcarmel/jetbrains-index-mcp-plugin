...
- `ide_open_workspace` - Scan a root directory for Maven projects and open them all in a single IntelliJ window with full cross-project code intelligence. Creates a temporary aggregator with symlinks. (disabled by default)
